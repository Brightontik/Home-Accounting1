...
Процедура ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики) Экспорт
	...
	ДБ_Заглушки.ОбработчикиИнициализацииПараметровСеанса(Обработчики);
	//Конец РегламентированнаяОтчетность
	
	// ДБ_Заглушки
	ДБ_Заглушки.ПриДобавленииОбработчиковУстановкиПараметровСеанса(Обработчики);
	// Конец ДБ_Заглушки
	...
	Обработчики.Вставить("СтатистикаОткрытияФорм", "ДБ_Заглушки.УстановитьСтатистикуОткрытияФорм");
...
Процедура ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры) Экспорт
	...
	ДБ_Заглушки.ПриДобавленииПараметровРаботыКлиентаПриЗапуске(Параметры);
	
	ДБ_Заглушки.ПараметрыРаботыКлиентаПриЗапуске(Параметры);
...
Процедура ПриДобавленииПараметровРаботыКлиента(Параметры) Экспорт
	...
	// ДБ_Заглушки
	ДБ_Заглушки.ПриДобавленииПараметровРаботыКлиента(Параметры);
	// Конец ДБ_Заглушки
...
Процедура ПриДобавленииПереименованийОбъектовМетаданных(Итог) Экспорт
	...
	ДБ_Заглушки.ПриДобавленииПереименованийОбъектовМетаданных(Итог);
	...
	// БЗКБ
	ДБ_Заглушки.ЗаполнитьТаблицуПереименованияОбъектовМетаданных(Итог);
...
Процедура ПередЗагрузкойПриоритетныхДанныхВПодчиненномРИБУзле(СтандартнаяОбработка) Экспорт
	...
	Если ЗначениеЗаполнено(ГлавныйУзел) Тогда 
		ДБ_Заглушки.ПеренестиНастройкиОбменаДанными(ГлавныйУзел, ГлавныйУзел);
	КонецЕсли;
...
Процедура ПриОпределенииПоддерживаемыхВерсийПрограммныхИнтерфейсов(ПоддерживаемыеВерсии) Экспорт
	...
	//РегламентированнаяОтчетность
	ДБ_Заглушки.ПриОпределенииПоддерживаемыхВерсийПрограммныхИнтерфейсов(ПоддерживаемыеВерсии);
	// Конец РегламентированнаяОтчетность
